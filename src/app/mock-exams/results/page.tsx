...
import { Award, TrendingUp, BookOpen, FileQuestion, ChevronRight, Home, RotateCcw, Layers } from 'lucide-react';
    ...
    const getRecommendations = () => {
        ...
        if (numScore < 70) {
            recs.push({
                ...
                link: '/student-dashboard/lessons'
            });
            recs.push({
                type: 'past_question',
            ...
            recs.push({
                ...
                link: '/student-dashboard/mock-exams'
            });
        }
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                        ...
                        {exam && (
                            <div className="mt-2">
                                <span className="text-xs font-medium text-primary bg-primary/10 px-2 py-1 rounded-full">
                                    {exam.level || 'O-Level'} • {exam.section || 'Science'}
                                </span>
                                <p className="text-gray-600 mt-1">{exam.title}</p>
                                <p className="text-sm text-gray-500">{exam.subject} ({exam.subject_code})</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="p-6 space-y-3">
                        ...
                        <button
                            ...
                            className="w-full py-3 border border-gray-200 rounded-lg font-semibold hover:bg-gray-50 flex items-center justify-center gap-2 text-gray-600"
                        >
